  ...
  return (
    <div className="settings-screen">
      <div className="settings-panel">
        ...
        <div className="settings-carousel-dots">
          {pages.map((p, i) => (
            <button
              key={p.key}
              className={`settings-carousel-dot ${activePage === i ? "settings-carousel-dot--active" : ""}`}
              onClick={() => goToPage(i)}
            >
              {p.label}
            </button>
        ...
        <div className="settings-carousel-track" ref={trackRef} onScroll={handleScroll}>
          ...
          {/* Page 4: More — Rate, Remove Ads, Contact Us, Log Out */}
          <div className="settings-carousel-page">
            <Section title="Rate">
