...
export const api = {
  ...
  completeOnboarding: (id, payload) => request(`/api/players/${id}/onboarding`, { method: "PATCH", body: JSON.stringify(payload) }),
  purchaseEmote: (id, emoteId) => request(`/api/players/${id}/emotes/purchase`, { method: "POST", body: JSON.stringify({ emoteId }) }),
  equipEmote: (id, emoteId) => request(`/api/players/${id}/equip-emote`, { method: "PATCH", body: JSON.stringify({ emoteId }) }),
